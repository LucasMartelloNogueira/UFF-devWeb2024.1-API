...
public interface SanctuaryPetRepository extends JpaRepository<SanctuaryPet, Integer>{
    ...
    @Query(value = "select * from tbsanctuarypets where sanctuaryid = :sanctuaryId and status = 'WAITING_ADOPTION'", nativeQuery = true)
    public List<SanctuaryPet> getAllPetsBySanctuary(@Param("sanctuaryId") int sanctuaryId);
